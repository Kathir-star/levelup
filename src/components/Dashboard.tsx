...
export default function Dashboard({ 
  ...
  return (
    <div className="space-y-3 sm:space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {/* 🛡️ Brand Identity Tactical HUD Tagline */}
      <div className="bg-gradient-to-r from-red-950/20 via-black to-red-950/20 border-y border-red-500/20 py-2.5 text-center relative overflow-hidden select-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-px bg-gradient-to-r from-transparent via-red-500 to-transparent" />
        <div className="text-[11px] sm:text-xs font-black uppercase tracking-[0.25em] text-red-500 flex items-center justify-center gap-2">
          <span>⚡ LEVELUP IS NOT MOTIVATION. IT'S DISCIPLINE. ⚡</span>
        </div>
        <div className="text-[8px] sm:text-[9px] font-bold tracking-[0.1em] text-neutral-400 mt-0.5 uppercase">
          TRAIN YOUR BODY. CONTROL YOUR MIND. STAY LOCKED IN.
        </div>
      </div>

      {/* ⚡ Tactical Command Core & Face Your Reality */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        
        {/* Quick Action Button Card */}
        <div className="glass-card p-4 bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/20 rounded-2xl flex flex-col justify-between relative overflow-hidden group shadow-md shadow-red-950/5">
          ...
          <div className="flex flex-col gap-2">
            <div className="w-8 h-8 bg-red-500/10 text-red-400 rounded-xl flex items-center justify-center shrink-0 border border-red-500/15">
              <Play size={14} fill="currentColor" />
            </div>
            <div>
              <h4 className="text-[9px] font-black text-[var(--muted)] uppercase tracking-widest leading-none">{recommendedSplit.desc}</h4>
              <div className="text-base font-display font-black tracking-tight text-white/95 mt-0.5 leading-tight">{recommendedSplit.label}</div>
            </div>
          </div>
          <button 
            onClick={() => {
        ...
        <div className="glass-card p-4 bg-gradient-to-br from-blue-500/10 to-transparent border border-blue-500/15 rounded-2xl flex flex-col justify-between relative overflow-hidden group shadow-md shadow-blue-950/5">
          ...
          <div className="flex flex-col gap-2">
            <div className="w-8 h-8 bg-blue-500/10 text-blue-400 rounded-xl flex items-center justify-center shrink-0 border border-blue-500/15">
              <Wind size={14} />
            </div>
            <div>
              <h4 className="text-[9px] font-black text-[var(--muted)] uppercase tracking-widest leading-none">Somatic Cortisol Reducer</h4>
              <div className="text-base font-display font-black tracking-tight text-white/95 mt-0.5 leading-tight">Calm & Focus baseline</div>
            </div>
          </div>
          <button 
            onClick={() => setShowResetMind(true)}
            className="w-full mt-3 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-display font-black text-xs uppercase tracking-widest transition-all cursor-pointer shadow-md shadow-blue-600/15"
          >
            🧘 Reset your mind. Take control.
          </button>
        </div>

        {/* Smart Insights Bento Column */}
        <div className="glass-card p-4 bg-gradient-to-br from-amber-500/5 to-transparent border border-white/5 rounded-2xl flex flex-col justify-between relative overflow-hidden shadow-md">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-1.5 leading-none">
              <Sparkles size={12} className="text-amber-400 animate-pulse" />
              <h4 className="text-[10px] font-black text-red-500 uppercase tracking-widest">Face Your Reality</h4>
            </div>
          ...
          <div className="text-[8px] uppercase font-bold text-[var(--muted)] tracking-wider mt-2 pt-2 border-t border-white/[0.03]">
